...
export default class DataProvider extends Component {
    ...
    getWeather = async (zipCode) => {
        ...
        console.log(data)
        this.setState({icon: data.weather[0].icon, name: data.name, currentTemp: data.main.temp, description: data.weather[0].description, 
        sunrise: data.sys.sunrise, temp_min: data.main.temp_min, temp_max: data.main.temp_max})
